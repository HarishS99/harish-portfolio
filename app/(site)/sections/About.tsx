...
export default function About() {
  return (
    <motion.section
      id="about" // replace with relevant ID
      className="max-w-3xl mx-auto mb-16 scroll-mt-28 px-4"
    ...
    <section id="about" className="max-w-3xl mx-auto mt-16 mb-16">
      ...
      <p className="opacity-80 mb-4">
        ...
        and Proof of Values to the business stakeholders. Pursuing my PGP in Advanced Business Analytics from IIM Ahmedabad to sharpen my strategic and analytical decision-making.
      </p>
    </section>
      </motion.section>
  );
