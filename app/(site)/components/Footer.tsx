...
export default function Footer() {
  return (
    <footer className="text-center mt-12 md:mt-16 mb-8 md:mb-6 opacity-80 text-xs sm:text-sm transition hover:opacity-100 px-4">
      <div className="flex justify-center gap-5 mb-3 flex-wrap">
        ...
        >
          <svg
            ...
            fill="currentColor"
          >
            <path d="M7 2C4.24 2 2 4.24 2 7v10c0 2.76 2.24 5 5 5h10c2.76 0 5-2.24 5-5V7c0-2.76-2.24-5-5-5H7zm10 2c1.66 0 3 1.34 3 3v10c0 2.66-1.34 3-3 3H7c-1.66 0-3-.34-3-3V7c0-1.66 1.34-3 3-3h10zm-5 3c-2.76 0-5 2.24-5 5s2.24 5 5 5 5-2.24 5-5-2.24-5-5-5zm0 2c1.66 0 3 1.34 3 3s-1.34 3-3 3-3-1.34-3-3 1.34-3 3-3zm4.5-3c-.83 0-1.5.67-1.5 1.5S15.67 9 16.5 9s1.5-.67 1.5-1.5S17.33 4 16.5 4z"/>
          </svg>
        </a>
      </div>
